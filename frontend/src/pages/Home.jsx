        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(270px, 1fr))', gap: 20 }}>
            {[
              ...
              { emoji: '🍎', title: 'App Store Reviews', desc: 'AI-powered replies for your Apple App Store reviews. One dashboard for both iOS and Android.', features: ['AI replies for iOS reviews', 'iOS version trends', 'Unified inbox with Play Store', 'One dashboard, both platforms'], link: '/products/app-store-reviews', linkLabel: 'Notify Me →', soon: true },
